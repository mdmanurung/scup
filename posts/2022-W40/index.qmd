...
**How should we integrate novel dataset and transfer annotations from the reference?** Meng Yang and colleagues presented [Concerto](https://www.nature.com/articles/s42256-022-00518-z) that leveraged [contrastive learning](https://www.v7labs.com/blog/contrastive-learning-guide#h1) approach to perform cell type classification, data integration, and reference mapping.^[https://www.nature.com/articles/s42256-022-00518-z]

## Conversations

**To integrate or not to integrate, that is the question.** Here's a thread by [Simona Cristea](https://twitter.com/simocristea) warning us [against blind application of data integration methods](https://twitter.com/simocristea/status/1578441680939732993). TL;DR always compare your data representation before and after integration and spend some time to understand why the two differs.[^2]

[^2]: https://twitter.com/simocristea/status/1578441680939732993

**How should we define cells in scATAC-Seq studies?** [Jason Buenrostro](https://twitter.com/JD_Buenrostro)'s call to 10X Genomics to improve the default cell thresholds for scATAC-Seq.[^3]

[^3]: https://twitter.com/JD_Buenrostro/status/1577683940906704896
...
Prof. Petter Brodin (Imperial College London) is [looking a post-doc to investigate the regulation and function of human immune systems in children of different ages and their relation to disease.](https://www.imperial.ac.uk/jobs/description/MED03406/research-associate)
